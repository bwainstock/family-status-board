...
48,000-byte buffer. It does not use satori, resvg, a headless browser, or any SVG or
...
**row-major, top-left origin, MSB-first, 1 bpp, bit=1 meaning black, 800 as the width**
— 100 bytes per row times 480 rows. A committed golden fixture guards it from both sides,
